...
namespace Ogre
{
    ...
    void MapHorizon::calcElevationCubeMap(uint size)
    {
        ...
        DEBUG_OUTPUT ( "Calculating Elevation map");
    ...
    Real MapHorizon::CalcHorizonAtPoint (uint localx, 
                                        uint localy,
                                        Vector3 direction,
                                        Real origin)
    {
                                    ...
                                    float step)
    {
        ...
        double tmp = mElevationHeight / step;
        ...
        DEBUG_OUTPUT ("Calculating horizon map");
        ...
        {           
            ...
            uint row_countj = 0; 
            DEBUG_OUTPUT ( StringConverter::toString (k) + " : ");
            ...
            {  
                ...
                for (uint i = 0; i < w; i++) 
                {
                    horizonmap2d[row_countj + i] = 255 - (255 *
