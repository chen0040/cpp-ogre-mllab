    ...
    */
    class MapSplitter
    {
        public :
            ...
            */
            void init (const bool paged, const uint pagesize, const uint bpp, 
                       const String &outDir);
            /**
            *
            ...
            * \param option yes if raw is the format to use
            */
            void setTerrainSave (bool option);
            /**
            *
            ...
            * \return true if done.
            */
            const bool save(const String &filename, uchar * const data, 
                            const uint width, const uint height,
            ...
            * \return true if done.
            */
            const bool saveExt(const String &filename, uchar * const data, 
                                const uint width, const uint height,
                                const uint NumBytesPP);
            
            const bool saveHeightData (const String &filename, Real *ogre_restrictHeightdata, 
                                        const uint width, const uint height);
        private :
            /**
            ...
            */
            ...
            const bool saveRaw (const String &filename, Real* ogre_restrict data,
                            const uint width, const uint height);

            const bool saveExt (const String &filename,  Real* ogre_restrict data,
                                const uint width, const uint height,
                                const uint NumBytesPP);
