/***************************************************************************
	OgreIPLTexture_Splatting2.h  -  description
	-------------------
...
#ifndef __IPLTEXTURE_SPLATTING2_H_
#define __IPLTEXTURE_SPLATTING2_H_
...
class IPLTexture_Splatting2 : public IPLTexture
{
public:
	IPLTexture_Splatting2( IPLPage* p );

	~IPLTexture_Splatting2( void );
