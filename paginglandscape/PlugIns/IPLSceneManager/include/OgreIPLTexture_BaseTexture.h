/***************************************************************************
	OgreIPLTexture_BaseTexture.h  -  description
  -------------------
...
#ifndef __IPLTEXTURE_BASETEXTURE_H_
#define __IPLTEXTURE_BASETEXTURE_H_
...
class IPLTexture_BaseTexture : public IPLTexture
{
public:
	IPLTexture_BaseTexture( IPLPage* p );

	~IPLTexture_BaseTexture( void );
