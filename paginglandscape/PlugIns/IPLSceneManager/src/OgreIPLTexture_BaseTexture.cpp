/***************************************************************************
	OgreIPLTexture_BaseTexture.cpp  -  description
-------------------
...
//-----------------------------------------------------------------------
IPLTexture_BaseTexture::IPLTexture_BaseTexture( IPLPage* p )
	: IPLTexture( p )
{
	tex = 0;
}
...
//-----------------------------------------------------------------------
IPLTexture_BaseTexture::~IPLTexture_BaseTexture( void )
{
	tex = 0;
}

//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::setupMaterial( int pageCount, IPLVirtualPageWindow* vw )
{
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::preLoad( void )
{
//	Image newImage;
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::_loadMaterial( void )
{
	ColourValue color;
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::_unloadMaterial( void )
{
	if ( mMaterial != 0 )
	{
		mMaterial->unload();
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::_BuildPoint( ColourValue& out, const int j, Real& alpha1, Real& alpha2, Real& alpha3, Real& alpha4 )
{
	// Init the colour
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::_InterpolateColour( ColourValue& out, const Real percentaje, const int index1, const int index2 )
{
...
//-----------------------------------------------------------------------
void IPLTexture_BaseTexture::_InterpolateAlpha( Real& alpha1, Real& alpha2, Real& alpha3, Real& alpha4, const Real percentaje, const int index1, const int index2 )
{
	if ( index1 == index2 )
	{
		if ( index1 == 0 )
