...
public class PixelRGBXY extends PixelRGB{
	protected int m_l;
	
	public PixelRGBXY(BufferedImage img, int x, int y)
	{
		super(img, x, y);
	...
	public PixelRGBXY(int r, int g, int b, int l)
	{
		super(r, g, b);
		m_l=l;
	}
	
	public PixelRGBXY(int r, int g, int b)
	{
		super(r, g, b);
		m_l=get_luminance(r, g, b);
	}
	
	public PixelRGBXY(int rgb)
	{
		super(rgb);
		m_l=get_luminance(rgb);
	}
	...
	{
		PixelRGBXY pt=new PixelRGBXY(m_r, m_g, m_b, m_l);
		return pt;
	}
