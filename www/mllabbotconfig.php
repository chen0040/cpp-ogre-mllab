...
{	
	...
	$query1="SELECT * FROM " . $tablename . " WHERE name='" . $_SESSION['username'] . "' AND param != 'username' AND param != 'scriptId' ORDER BY scriptId";
	$result=mysql_query($query1) or die(mysql_error());
	$content= mllab_markup_sql_table($result, "color: $000000", array('name', 'scriptId', 'param', 'value'));
	mllabbody("MLLab Bot Configuration", $content);
	echo "</body></html>";
}
else
{
